...
import {
  SIGNUP_MUTATION, EMAIL_LOGIN_MUTATION,
  MOBILE_LOGIN_MUTATION, RESET_PASSWORD_MUTATION
...
import PharmIQBig from '../../assets/images/PharmIQBig.png';
    ...
    ResetPassword({
      ...
      .then((data) => {
        ...
        this.setState({
          ...
          EmailError: false,
          helperEmailText: (
            <FormHelperText className="valid">{success}</FormHelperText>
          )
        });
      })
      .catch((err) => {
      ...
      <Grid container className={classes.container}>
        ...
        <Grid item container className={classes.wrapperGrid}>
          <Grid item container xs={5} className={classes.logo}>
            <img style={{ width: '80%' }} src={PharmIQBig} alt="PharmIQ" />
            ...
            <Paper elevation={2} className={classes.contentPaper}>
              {path === '/register' ? (
                ...
                <Login
                  ...
                  handleOpenForgotPasswordAlert={
                    this.handleOpenForgotPasswordAlert
                  }
                  handleCloseForgotPasswordAlert={
                    this.handleCloseForgotPasswordAlert
                  }
                />
              )}
            </Paper>
...
)(withStyles(login)(withApollo(AuthContainer)));
