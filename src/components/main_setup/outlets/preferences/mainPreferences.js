                              ...
                              <Grid item xs={12} style={MainPreferencesStyles.sectionContent}>
                                ...
                                <Grid container style={MainPreferencesStyles.formContainer}>
                                  ...
                                  >
                                    ...
                                    <Button
                                      variant="contained"
                                      color={selectedPayment === 'bank_transfer' ? 'primary' : 'default'}
                                      onClick={this.handlePayment('bank_transfer')}
                                    >
                                      Bank Transfer
                                    </Button>
                                    <Button
                                      variant="contained"
                                      color={selectedPayment === 'all' ? 'primary' : 'default'}
                                      onClick={this.handlePayment('all')}
                                    >
                                      All
                                    </Button>
                                  </Grid>
