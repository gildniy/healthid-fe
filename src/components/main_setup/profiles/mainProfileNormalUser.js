      ...
      <Grid container style={styles.container}>
        ...
        <Grid item xs={10}>
          <Grid style={styles.profileHeader}>
            ...
            <Link
              to="/main_setup/profile/manage_profile_user"
            ...
            <Grid item style={styles.profileBox}>
              <Grid item xs={4} style={styles.formRow}>
                <TextField
                  ...
                  label="First Name"
                  value={
                    data && data.firstName ? data.firstName : 'Not Available'
                  }
                  margin="normal"
                ...
                <TextField
                  ...
                  label="Username"
                  value={
                    data && data.username ? data.username : 'Not Available'
                  }
                  margin="normal"
                  style={styles.textField}
                  InputProps={{ disableUnderline: true, readOnly: true }}
              ...
              <Grid item xs={4} style={styles.formRow}>
                <TextField
                  ...
                  label="Last Name"
                  value={
                    data && data.lastName ? data.lastName : 'Not Available'
                  }
                  margin="normal"
                  style={styles.textField}
                  InputProps={{ disableUnderline: true, readOnly: true }}
                ...
                <TextField
                  ...
                  label="Birthday"
                  value={
                    data && data.birthday ? data.birthday : 'Not Available'
                  }
                  margin="normal"
                  style={styles.textField}
                  InputProps={{ disableUnderline: true, readOnly: true }}
            ...
            <Grid item style={styles.profileBox}>
              <Grid item xs={4} style={styles.formRow}>
                <TextField
                  ...
                  label="Role"
                  value={
                    data && data.role.name ? data.role.name : 'Not Available'
                  }
                  margin="normal"
                  style={styles.textField}
                  InputProps={{ disableUnderline: true, readOnly: true }}
              ...
              <Grid item xs={4} style={styles.formRow}>
                <TextField
                  ...
                  label="Job Title"
                  value={
                    data && data.jobTitle ? data.jobTitle : 'Not Available'
                  }
                  margin="normal"
                  style={styles.textField}
                  InputProps={{ disableUnderline: true, readOnly: true }}
