...
const UPDATE_PASSWORD = graphql(UPDATE_USER_PASSWORD, {
  name: 'updatePassword'
});
export class ManageProfile extends Component {
  constructor(props, context) {
    ...
    this.state = {
      ...
      secondaryPhoneNumber:
        me && me.secondaryPhoneNumber ? me.secondaryPhoneNumber : 'N/A',
  ...
  handlePassword = (
    ...
    if (currentPassword === newPassword) {
      ...
      return notify(
        'The current password entered is the same as the new password'
      );
    }
  ...
  handleSubmit = () => {
    ...
    const { isDataChanged, data } = this.isUserDataChanged(
      initialUserData,
      newData
    );
...
export default withAuth(compose(UPDATE_PASSWORD, UPDATE_USER)(ManageProfile));
