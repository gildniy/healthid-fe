    ...
    <table className="fields-table-products">
      <tbody>
        <tr className="fields-tr">
          ...
          <td className="required-field">
            <div className="required-field-name">Global UPC</div>
            <li>Enter unique product global UPC</li>
            <li>to enable barcode scanning</li>
            <span>optional</span>
          </td>
          <td className="required-field">
        ...
        <tr className="fields-tr">
          ...
          <td className="required-field">
            ...
            <li>The # of loyalty points members</li>
            <li>receive during purchase</li>
            <span>required</span>
          </td>
          <td className="required-field">
        ...
        <tr className="fields-tr">
          <td className="required-field">
            <div className="required-field-name">Reorder Point</div>
            <li>Flag product for reorder when</li>
            <li>it falls below this set quantity</li>
            <span>optional</span>
          </td>
          <td className="required-field">
            <div className="required-field-name">Reorder Max</div>
            <li>Product should not exceed this</li>
            <li>set quantity at any point</li>
            <span>optional</span>
          </td>
          <td className="required-field">
