...
import {
  Typography, Grid, Table, TableBody, TableCell, TableHead, TableRow, Paper, IconButton, Tooltip
      ...
      <Fragment>
        ...
        <div className={classes.dividerDiv}>
          <Grid container justify="space-between">
            ...
            <Grid item>
              <Tooltip title="Add supplier note">
                <IconButton
                  className={classes.notesButton}
                  aria-owns="menu-list-grow"
                  aria-haspopup="true"
                  onClick={this.handleopenAddModel}
                >
                  <NoteAddIcon />
                </IconButton>
              </Tooltip>
        ...
        <Grid container spacing={1} className={classes.tableGrid} style={{ borderBottom: 'none !important', marginTop: '15px' }}>
          {
                  ...
                  <Table className={tableStyles.table}>
                    <TableHead>
                      <TableRow style={tableStyles.noteRow}>
                        ...
                        {renderTableCell('left', tableStyles.tableHeaderCenter, '')}
                      </TableRow>
                    </TableHead>
                    <TableBody>
