    ...
    <Fragment>
      <Paper elevation={2} style={styles.paper}>
        <Grid item container xs={12} justify="center" style={styles.headerWrapper}>
          <Typography variant="h6">Import Customers Batch CSV</Typography>
        </Grid>
        <Divider light />
        <Grid container style={styles.importContainer}>
          ...
          >
            <Typography variant="subtitle1" style={styles.tempTypo}>
              Download sample template to import customer batches
            </Typography>
            <Button
              style={ButtonStyle}
...
export default CustomersCsvForm;
