...
export const DataTable = ({
  ...
  rowsPerPage, page, handleChangePage, handleChangeRowsPerPage, isSearching, state
}) => {
              ...
              <TableBody>
                {getSortedData(rows, page, rowsPerPage, order, orderBy)
                  .map((row) => {
                    ...
                    const {
                      id, productName, skuNumber, salesPrice, markup,
                      unitCost, grossMargin, category, loyaltyWeight, vatStatus
                    } = row;
                    return (
                      <TableRow
                        role="checkbox"
                      ...
                      >
                        ...
                        <TableCell align="left">{unitCost}</TableCell>
                        <TableCell align="left">{grossMargin}</TableCell>
