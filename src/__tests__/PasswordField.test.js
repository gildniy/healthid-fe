...
describe('PasswordField', () => {
  it('renders without crashing', () => {
    ...
    expect(wrapper.find('ForwardRef(FormControl)').length).toBe(1);
    expect(wrapper.find('ForwardRef(InputLabel)').length).toBe(1);
    expect(wrapper.find('ForwardRef(Input)').length).toBe(1);
  });
