...
import { Categories } from '../../../../components/main_setup/outlets/preferences/productCategories';
...
describe("Product Categories", () => { 
  const wrapper = shallow(
    <Categories
      ...
      handleOpenPopper={jest.fn()}
      handleClosePopper={jest.fn()}
  ...
  it("Should render the categories component", () => {
    const event = { currentTarget: { id: '1' } };
    wrapper.find('WithStyles(ForwardRef(IconButton))').at(2).simulate('click', event);
    wrapper.find('WithStyles(ForwardRef(Button))').at(1).simulate('click', event);
    wrapper.find('WithStyles(ForwardRef(Button))').at(0).simulate('click', 1, event);
    wrapper.find('WithStyles(ForwardRef(Grid))').at(13).props().onMouseEnter(1);
    wrapper.find('WithStyles(ForwardRef(Grid))').at(13).props().onMouseLeave();
