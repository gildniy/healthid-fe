...
describe('SuppliersPage ', () => {
  ...
  it('renders without error', async () => {
     wrapper = shallow(<Router><MockedProvider mocks={mocks} addTypename={false}><SuppliersPageWrapper {...props} /></MockedProvider></Router>);
    await wait(0);
  ...
  it('update props ', async () => {
    wrapper = shallow(<SuppliersPageWrapper {...props} />, { context });
