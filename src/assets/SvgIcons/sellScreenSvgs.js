...
export const Online = props => (
  <SvgIcon {...props} xmlns="http://www.w3.org/2000/svg" width="898.199" height="711.002" viewBox="0 0 898.199 921">
    <circle cx="93.4" cy="93.4" r="93.4" transform="translate(356.901 617.8)" fill="#424242" />
    <path d="M716.8,463.8a376.584,376.584,0,0,0-537.6,4.6l115,111.2a216.971,216.971,0,0,1,309.4-2.7Z" fill="#424242" />
    <path d="M450.3,93.6A635.442,635.442,0,0,0,0,280.1L113.1,393.2a474.514,474.514,0,0,1,337-139.6c126.5,0,245.6,49,335.5,138L898.2,277.9A634.4,634.4,0,0,0,450.3,93.6Z" fill="#424242" />
  </SvgIcon>
);

export const Offline = props => (
  <SvgIcon {...props} xmlns="http://www.w3.org/2000/svg" width="898.199" height="711.002" viewBox="0 0 898.199 911">
    <path d="M501.344,666.276a86.156,86.156,0,1,1-86.156-86.154A86.137,86.137,0,0,1,501.344,666.276Zm49.165-302.558A345.2,345.2,0,0,0,466.384,340.1L612.775,486.4l48.243-48.244A344.912,344.912,0,0,0,550.509,363.718Zm-283.1,5.443A345.306,345.306,0,0,0,165.207,442.31l106.08,102.576a198.6,198.6,0,0,1,113.09-58.759ZM91.874,193.529A584.493,584.493,0,0,0,0,268.616L104.327,372.943A437.183,437.183,0,0,1,199.154,300.9Zm550.695-51.287A589.505,589.505,0,0,0,247.4,120.934L372.663,246.2c14.022-1.384,28.228-2.029,42.524-2.029,116.688,0,226.552,45.2,309.478,127.3l103.96-104.789A585.611,585.611,0,0,0,642.569,142.242ZM50.179,97.873,626.794,674.488l60.052-60.052L110.231,37.821Z" fill="#702632" />
  </SvgIcon>
);
